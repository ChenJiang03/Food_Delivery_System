...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${path}/manage/rider/list">首页</a><span
                    class="crumb-step">&gt;</span><a class="crumb-name" href="${path}/manage/rider/list">骑手管理</a><span
                    class="crumb-step">&gt;</span><span>新增骑手</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${path}/manage/rider/add" method="post" id="myform" name="myform"
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="username" name="username" size="50" value=""
                                       type="text">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="password" name="password" size="50" value=""
                                       type="password">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="identification" name="identification" size="50"
                                       value="" type="text">
                        ...
                        <tr>
                            ...
                            <td>
                                <div id="pimg">
                                    <input type="hidden" accept="image/*" name="picture" id="pic">
                        ...
                        <tr>
                            <th><i class="require-red">*</i>骑手是否可工作：</th>
                            <td>
                                <input type="radio" name="available" value="0">否 <input type="radio" checked
                                                                                        name="available" value="1">是
                            </td>
                        </tr>
                        <tr>
                            <th></th>
...
<script type="text/javascript">
    ...
    function checkUsername() {
        ...
        if (!usernameExp.test(username)) {
            $("#usernameMsg").html("用户名格式错误，请输入5-20位字母数字下划线");
