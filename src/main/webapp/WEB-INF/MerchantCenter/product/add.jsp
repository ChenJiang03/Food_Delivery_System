...
<section class="Psection MT20">
    <form action="${path}/MerchantCenter/product/add?merchantId=${sessionScope.merchant.id}" id="myform" method="post" enctype="multipart/form-data">
        <table class="Register">
            <tr>
                <td width="40%" align="right" class="FontW">*标题：</td>
                <td><input type="text" name="title" id="title" value=""><span id="address1"></span></td>
            </tr>
            <tr>
                <td width="40%" align="right" class="FontW">*价格：</td>
                <td><input type="text" name="price" id="price" value=""><span id="phone1"></span></td>
            </tr>
            <tr>
                <td width="40%" align="right" class="FontW">*库存状态：</td>
                <td><input type="radio" name="stock" value="1" >有货  <input type="radio" name="stock" value="0">无货<span id="name1"></span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><textarea name="description" cols="30" style="width: 50%;" rows="10"></textarea></td>
            </tr>
            <tr>
